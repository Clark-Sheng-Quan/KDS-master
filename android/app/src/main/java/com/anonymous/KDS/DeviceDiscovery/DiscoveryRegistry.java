...
public class DiscoveryRegistry {
    ...
    public static final String STABLE_ID_KEY = "stableId";
    ...
    private void BroadcastService() {
        ...
        serviceInfo.setServiceName(SERVICE_NAME);         // Name
        serviceInfo.setServiceType(SERVICE_TYPE);         // Cust protocol
        serviceInfo.setPort(SERVICE_PORT);                //
        // uniquelookup.
        serviceInfo.setAttribute(STABLE_ID_KEY, SERVICE_NAME);
